...
// ============================================================================	//	NO		############# TODO
public class GUITiroAlBlanco1a {												//	ESTA	############# TODO
// ============================================================================	//	HECHO	############# TODO
					...
					public void actionPerformed( ActionEvent e ) {
						...
						try {
							...
							if( ( 0.0 < angulo )&&( angulo < 90 )&&( velocidad > 0 ) ) {
								...
								//Código cortado aquí TODO
								new MiHebraCalculadora(cnvCampoTiro, txfMensajes, p);
...
class MiHebraCalculadora extends Thread {
	...
	volatile CanvasCampoTiro1a cnvCampoTiro;
	volatile JTextField txfMensajes;
	volatile Proyectil1a p;
	String mensaje;
